...
var reglesPicolo100 = [{"regle":"&& boit ## de gorgées a chaque tour jusqu'a ce que tu sois appelé à nouveau.", "joueurs":1},
                      ...
                      {"regle":"Chambranle : Le dernier à taper sa tête contre une surface solide (Ex : table, mur, chaise...) bois ## gorgées.", "joueurs":0},
                      {"regle":"Chambranle : Le dernier à taper sa tête contre une surface solide (Ex : table, mur, chaise...) bois ## gorgées.", "joueurs":0},
                      {"regle":"A partir de maintenant, et jusqu'à la fin du jeu, vous avez de dénoncer un joueur faisant trop de bruit, si la majorité des autres joueur sont d'accord, il doit boire ## gorgées.", "joueurs":0},
                      ...
                      {"regle":"&& distribue autant de gorgées que tu le souhaite, en revanche tu doit en boire le double", "joueurs":1},
                      {"regle":"Il fait soif.", "joueurs":0},
                      ...
                      {"regle":"&&, tu designe un lieu accessible actuellement, le joueur à ta gauche désigne quoi faire, le suivant, comment cela devra etre fait (à poil par exemple), le suivant s'execute. ", "joueurs":1},
                      {"regle":"&&, désigne l'heureux élu qui aura l'honneur de terminer ton verre.", "joueurs":1},
                       ...
                       {"regle":"&& est le chimiste pour ce tour, tu peux créer le verre que tu veux à qui tu veux.", "joueurs":1},
                       {"regle":"&& est le chimiste pour ce tour, tu peux créer le verre que tu veux à qui tu veux.", "joueurs":1},
                       {"regle":"&& est le chimiste pour ce tour, tu peux créer le verre que tu veux à qui tu veux.", "joueurs":1},
                       {"regle":"&& mange une serviette en papier ou finis ton verre.", "joueurs":1},
                       {"regle":"&& reçoit un Teton-fire.", "joueurs":1},
